    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_role', models.CharField(choices=[('Administrator', 'Administrator'), ('Owner', 'Owner'), ('client', 'client'), ('Courier', 'Courier')], default='client', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='store.review')),
